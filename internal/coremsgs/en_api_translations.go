...
var (
	...
	APIEndpointsGetExecutors          = ffm("api.endpoints.getExecutors", "Gets a list of dai executors")
	APIEndpointsGetExecutorByNameOrID = ffm("api.endpoints.getExecutorByNameOrID", "Gets a dai executor by its name or its ID")
	APIParamsExecutorNameOrID         = ffm("api.params.getExecutorByNameOrID", "The dai executor name or ID")
	APIEndpointsPostExecutor          = ffm("api.endpoints.postExecutor", "Creates a new dai executor")
	APIEndpointsGetTasks              = ffm("api.endpoints.getTasks", "Gets a list of dai tasks")
	APIEndpointsGetTaskByNameOrID     = ffm("api.endpoints.getTaskByNameOrID", "Gets a dai task by its name or its ID")
	APIParamsTaskNameOrID             = ffm("api.params.getTaskByNameOrID", "The dai task name or ID")
	APIEndpointsPostTask              = ffm("api.endpoints.postTask", "Creates a new dai task")
	APIEndpointsPostTastStart         = ffm("api.endpoints.postTaskStart", "Start a task")
	APIEndpointsPostTastStop          = ffm("api.endpoints.postTaskStop", "Stop a task")
)
