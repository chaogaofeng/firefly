...
var (
	...
	APIEndpointsGetTrainingNode      = ffm("api.endpoints.getTrainingNode", "Gets a training node by its name or id")
	APIEndpointsGetTrainingNodes     = ffm("api.endpoints.getTrainingNodes", "Gets a list of training node that have been published")
	APIEndpointsPostNewTrainingNode  = ffm("api.endpoints.postNewTrainingNode", "Creates and broadcasts a new training node")
	APIEndpointsGetTrainingModel     = ffm("api.endpoints.getTrainingModel", "Gets a training model by its name or id")
	APIEndpointsGetTrainingModels    = ffm("api.endpoints.getTrainingModels", "Gets a list of training model that have been published")
	APIEndpointsPostNewTrainingModel = ffm("api.endpoints.postNewTrainingModel", "Creates and broadcasts a new training model")
	APIEndpointsGetTrainingTask      = ffm("api.endpoints.getTrainingTask", "Gets a training task by its name or id")
	APIEndpointsGetTrainingTasks     = ffm("api.endpoints.getTrainingTasks", "Gets a list of training task that have been published")
	APIEndpointsPostNewTrainingTask  = ffm("api.endpoints.postNewTrainingTask", "Creates and broadcasts a new training task")
	APIEndpointsGetTrainingJob       = ffm("api.endpoints.getTrainingJob", "Gets a training job by its name or id")
	APIEndpointsGetTrainingJobs      = ffm("api.endpoints.getTrainingJobs", "Gets a list of training job that have been published")
	APIEndpointsPostTrainingJob      = ffm("api.endpoints.postTrainingJob", "Creates and broadcasts a new training job")

	APIParamsTrainingNodeNameOrID  = ffm("api.params.trainingNodeNameOrID", "The training node name or ID")
	APIParamsTrainingModelNameOrID = ffm("api.params.trainingModelNameOrID", "The training model name or ID")
	APIParamsTrainingTaskNameOrID  = ffm("api.params.trainingTaskNameOrID", "The training task name or ID")
	APIParamsTrainingJobNameOrID   = ffm("api.params.trainingjobNameOrID", "The training job name or ID")
)
